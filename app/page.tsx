...
export default function Page() {
  const [state, setState] = useState<SkeletonState>(DEFAULT_SKELETON_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Skeleton Studio" controls={controls} preview={output} /></AppShell>;
}
