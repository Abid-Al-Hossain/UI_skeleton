...
export type SkeletonState = {
  ...
  showAvatar: boolean;
  showMedia: boolean;
  animation: "none" | "fade" | "scale" | "slide" | "shimmer";
  duration: number;
  reducedMotion: boolean;
};

export type StudioPreset = { id: string; family: string; archetype: string; variant: string; size: string; tags: string[]; state: Partial<SkeletonState> & Record<string, unknown> };
